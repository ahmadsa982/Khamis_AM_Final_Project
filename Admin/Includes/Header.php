                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" name="search" placeholder="Search for datas &amp; reports..." style="background-color: #365b6d; color: #f7f7f7;"/>
                                <button class="au-btn--submit" type="submit" style="background-color: #41c1ba; color: #f7f7f7;" >
                            ...
                            <div class="header-button" style="background-color: #365b6d;">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content" >
                                            <a class="js-acc-btn" href="#" style="color: #f7f7f7;">john doe</a>
                                        </div>
